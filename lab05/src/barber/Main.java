...
public class Main {
    ...
    // TODO: add semaphores
    public final static Semaphore clientsSemaphore = new Semaphore(0);
    public final static Semaphore barberReadySemaphore = new Semaphore(0);
    public final static Semaphore chairsSemaphore = new Semaphore(1);
